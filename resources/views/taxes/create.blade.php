...
@section('content')
    <div class="container mt-5">
        <h2 class="page-title text-center mb-5">إضافة ضريبة جديدة</h2>
                    ...
                    <div class="card-body p-5">
                        <form action="{{ route('taxes.store') }}" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" id="name" name="name" class="form-control form-control-lg" placeholder="أدخل اسم الضريبة" required>
                            </div>
                            <div class="form-group mb-5">
                                <label for="rate" class="form-label">معدل الضريبة (%):</label>
                                <input type="number" id="rate" name="rate" class="form-control form-control-lg" step="0.01" placeholder="أدخل معدل الضريبة" required>
                            </div>

                            <div class="text-center">
                                <button type="submit" class="btn btn-primary btn-lg w-50">إضافة الضريبة</button>
                            </div>
                        </form>
                    </div>
                </div>
